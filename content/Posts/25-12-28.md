...
title: New SSDs - Part One
---
Following on from the [[25-11-29|ZFS Storage Pool Troubles?]] post, I'm close to finally replacing the DRAMless SSDs with 'DRAMfull' NVMe SSDs! Whoop! But getting this far was, uh, needlessly difficult... 

So my first though upon getting home from uni was to open up server 2 and check if it had any slots for NVMe SSDs. Nope it does not. Ok not to worry, you can by adaptors to let them work through PCIe x16 slots, which through my research seems to have a minimal or no impact to the read/write speeds. 
...
- ~~Western Digital WD_Black SN850X~~ - Earliest delivery too late 
...
so, it's been about 2 weeks since we ordered them, and I wrote this, and they've still not been dispatched. I go back to uni next week. If they don't arrive in the next few days we're gonna have to wait until April 🙃